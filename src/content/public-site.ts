...
export const PLAYBOOK = {
  ...
  chapters: [
    ...
    { slug: "distribution-is-a-place-not-a-blast", title: "Distribution is a place, not a blast", summary: "Publish where the buyer is, often enough to be remembered.", scene: "sorter", keyIdea: "The buyer for a £20,000 engagement is not on every platform. Distribution is choosing the two rooms they are in and turning up there with the same argument until it is familiar. Nobody hires the person they saw once.", reveal: { prompt: "The measurement rule", answer: "If a piece has no tracked link and no call to action, its commercial result cannot be observed later. It can still be worth publishing, but say so at the time, not afterwards." }, practice: "For your last five pieces, write down how a buyer could have got in touch from each. Count the pieces where the answer is 'they couldn't'." },
    { slug: "write-down-what-you-expect", title: "Expect first, then measure what the buyer did", summary: "The learning loop starts before the piece goes out.", scene: "inspector", keyIdea: "Write down what you expect before a piece goes out, one sentence and a rough band. Two weeks later, read what the buyer did against it: a tracked click, a form, a booked call, someone saying they saw it. Views tell you a piece travelled, not where.", reveal: { prompt: "What a diagnosis is", answer: "A named, checkable hypothesis about why the gap exists: idea, targeting, hook, delivery, retention, proof, distribution, call-to-action. Or 'too early to read'. Never 'the algorithm'." }, practice: "For your next piece, write one line: 'I expect this to do about X because Y.' Read it in 14 days." },
  ...
  closing: { title: "This playbook is the fifth of the system we can give away.", lead: "If you run a 7, 8 or 9-figure firm and want the other four-fifths run for you, book a call.", cta: { label: "Book a call", href: "/apply" } },
};
